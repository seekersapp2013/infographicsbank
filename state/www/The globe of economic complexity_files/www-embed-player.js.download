...
this))}
C(mi,ji);k=mi.prototype;k.la=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&Yh(a)){var d=b;if(z(d[0])&&!x(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=$h.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Zh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=ai.apply(window,d)}d=e}b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);Yh(a)&&li(this,this.Z())}};
